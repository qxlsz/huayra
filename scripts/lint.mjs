...
if (!consoleSrc.includes("parseSseEvents") || !consoleSrc.includes("HuayraSse")) {
  failed += 1;
  process.stderr.write("playground/app.js must render live think lines via HuayraSse.parseSseEvents\n");
}
