...
await copyFile(join(root, "playground", "app-part-3.js"), join(dist, "app-part-3.js"));
await copyFile(join(root, "playground", "app-part-4.js"), join(dist, "app-part-4.js"));
await copyFile(join(root, "playground", "app-part-5.js"), join(dist, "app-part-5.js"));
await copyFile(join(root, "playground", "app-part-6.js"), join(dist, "app-part-6.js"));
await copyFile(join(root, "playground", "app-part-7.js"), join(dist, "app-part-7.js"));
